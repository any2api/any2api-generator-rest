...
var updateSpecRamlSync = function(args) {
  ...
  // Parameters schema
  var paramsSchema = invoker.parameters_schema || executable.parameters_schema;
  var paramsRequired = invoker.parameters_required || executable.parameters_required;
  ...
  // Results schema
  var resultsSchema = invoker.results_schema || executable.results_schema;

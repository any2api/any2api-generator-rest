...
var updateSpecRamlSync = function(args) {
  ...
  // Generate examples
  var reqExample = JSON.stringify(util.generateExampleSync({ parameters_schema: parameters_schema,
                                                             parameters_required: parameters_required }), null, 2);

  var resExample = JSON.stringify(util.generateExampleSync({ parameters_schema: parameters_schema,
                                                             parameters_required: parameters_required }), null, 2);
